...
describe('Date Parser', () => {
    it('should parse yyyy-mm-dd H:MM', () => {
        ...
        expect(date).toEqual(new Date('1994-03-21 12:00'));
    });
    ...
    it('should parse yyyy-mm-dd 12:MM am', () => {
        ...
        let date = DateParser.parseDate(dateStr, format);
        expect(date).toEqual(new Date('1994-03-21 00:00'));
    });
    ...
    it('should parse yyyy-mm-dd H:MM pm', () => {
        ...
        let date = DateParser.parseDate(dateStr, format);
        expect(date).toEqual(new Date('1994-03-21 18:34'));
    });
    ...
    it('should parse m/dd/yy H:MM', () => {
        ...
        let date = DateParser.parseDate(dateStr, format);
        expect(date).toEqual(new Date('2094-03-21 18:34'));
    });
    ...
    it('should parse m/dd/yyyy H:MM', () => {
        ...
        let date = DateParser.parseDate(dateStr, format);
        expect(date).toEqual(new Date('2018-03-21 3:34'));
    });
    ...
    it('should parse dd.mm.yyyy', () => {
        ...
        let date = DateParser.parseDate(dateStr, format);
        expect(date).toEqual(new Date('2034-08-15 00:00'));
    });
